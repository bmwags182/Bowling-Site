...
<!-- NAV -->
    ...
    <?php if(isset($_SESSION['authorized'])) { ?><a href="<?php echo DIR . "/user-profile.php"; ?>" style="position:absolute; top:10px; right:10px;" >Profile</a><?php } else { ?><a href="<?php echo DIRADMIN;?>" style="position:absolute; top:10px; right:10px;" >Login</a><?php } ?>
        </div>
    </div>
    <!-- END NAV -->
